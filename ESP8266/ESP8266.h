...
class ESP8266 {
 public:
     ...
     */
    ESP8266(SoftwareSerial &uart, uint32_t baud, boolean debug_mode);
#else /* HardwareSerial */
    /*
     * Constuctor. 
     *
    ...
    ESP8266(HardwareSerial &uart, uint32_t baud, boolean debug_mode);
#endif
 ...
 private:
    uint32_t baud_rate;  // added by Uz
    boolean debug;       // added by Uz
    ...
    bool sATSYSWDT(void); // Added by Uz
    bool sATCIOBAUD(uint32_t baud); // by Uz
